                        ...
                        <div class="card">
                            <div class="card-body">
                                <?php echo form_open(base_url() . 'incident/create_schedule/' . $incident['id'], 'form-horizontal'); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group mt-2">
                                            <label for="inputHorizontalSuccess" class="col-form-label">Schedule Date</label>
                                            <input name="sched_date"  id="dateInput" type="date" class="form-control <?php echo (form_error('sched_date') ? "is-invalid" : ""); ?>" id="inputHorizontalSuccess" >
                                            <?php echo form_error('sched_date', '<div class="invalid-feedback">', '</div>'); ?>  
                                        </div>
                                    </div>
