                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#reactivate-modal-<?php echo $admin['id']; ?>">Reactivate Account</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>

                                                <div id="reactivate-modal-<?php echo $admin['id']; ?>" class="modal fade" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Reactivating this admin account will restore their access to the system.</p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-light"
                                                                    data-bs-dismiss="modal">Close</button>
                                                                <a class="btn btn-primary" href="<?php echo base_url() . "admin/action/activate/" . $admin['id']; ?>">Proceed</a>
                                                            </div>
                                                        </div><!-- /.modal-content -->
                                                    </div><!-- /.modal-dialog -->
                                                </div><!-- /.modal -->
