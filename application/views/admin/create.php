            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="card">
                            <div class="card-body">
                                <?php echo form_open(base_url() . 'admin/create', 'form-horizontal'); ?>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 mt-2">
                                            <label for="inputHorizontalSuccess" class="col-form-label">Email Address</label>
                                            <input name="email" type="email" class="form-control <?php echo (form_error('email') ? "is-invalid" : ""); ?>" id="inputHorizontalSuccess">
