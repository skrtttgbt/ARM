                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#reset-modal-<?php echo $admin['id']; ?>">Reset Password</a>
                                                                <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#suspend-modal-<?php echo $admin['id']; ?>">Suspend Account</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>

                                                <div id="reset-modal-<?php echo $admin['id']; ?>" class="modal fade" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-primary" href="<?php echo base_url() . "admin/action/reset/" . $admin['id']; ?>">Proceed</a>
                                                            </div>
                                                        </div><!-- /.modal-content -->
                                                    </div><!-- /.modal-dialog -->
                                                </div><!-- /.modal -->

                                                <div id="suspend-modal-<?php echo $admin['id']; ?>" class="modal fade" tabindex="-1" role="dialog"
                                                    aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myModalLabel">Suspend Account</h4>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                    aria-hidden="true"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <p>This action will temporarily disable the use of this account.</p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-light"
                                                                    data-bs-dismiss="modal">Close</button>
                                                                <a class="btn btn-danger" href="<?php echo base_url() . "admin/action/suspend/" . $admin['id']; ?>">Proceed</a>
                                                            </div>
                                                        </div><!-- /.modal-content -->
                                                    </div><!-- /.modal-dialog -->
                                                </div><!-- /.modal -->
