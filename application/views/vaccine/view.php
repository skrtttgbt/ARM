                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> 
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"> <a class="has-arrow sidebar-link" href="<?php echo base_url(); ?>vaccine"
                                                aria-expanded="false"><span class="hide-menu"> List</span></a>
                                            <ul aria-expanded="false" class="collapse second-level base-level-line">
                                                <li class="sidebar-item">
                                                    <a href="<?php echo base_url(); ?>vaccine/view/<?php echo $vaccine['id']; ?>"  class="sidebar-link">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="card">
                            <div class="card-body">
                                <?php echo form_open(base_url() . 'vaccine/view/' . $vaccine['id'], 'form-horizontal'); ?>
                                    
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label for="inputHorizontalSuccess" class="col-form-label">Barcode</label>
                                            <input name="barcode" type="text" value="<?php echo $vaccine['barcode']; ?>" class="form-control" disabled>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 mt-2">
                                            ...
                                            <input name="name" type="text" value="<?php echo $vaccine['name']; ?>" class="form-control <?php echo (form_error('name') ? "is-invalid" : ""); ?>" id="inputHorizontalSuccess">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 mt-2">
                                            ...
                                            <input name="capacity" type="number" value="<?php echo $vaccine['capacity']; ?>"  class="form-control <?php echo (form_error('capacity') ? "is-invalid" : ""); ?>" id="inputHorizontalSuccess">
                                        ...
                                        <div class="form-group col-md-6 mt-2">
                                            ...
                                            <select class="form-select" name="amount">
                                                <option value="1" <?php echo ($vaccine['amount'] == "1" ? "selected" : ""); ?>>1</option>
                                                <option value="2" <?php echo ($vaccine['amount'] == "2" ? "selected" : ""); ?>>2</option>
                                                <option value="3" <?php echo ($vaccine['amount'] == "3" ? "selected" : ""); ?>>3</option>
                                                <option value="4" <?php echo ($vaccine['amount'] == "4" ? "selected" : ""); ?>>4</option>
                                                <option value="5" <?php echo ($vaccine['amount'] == "5" ? "selected" : ""); ?>>5</option>
                                                <option value="6" <?php echo ($vaccine['amount'] == "6" ? "selected" : ""); ?>>6</option>
                                            </select>
